...
state: NY
content_type: html
source_url: https://www.tompkinscountyny.gov/All-Departments/Recycling-Materials-Management/Other-Programs-and-Services/Household-Hazardous-Waste-HHW
---
...
Household Hazardous Waste (HHW) | Tompkins County
...
Registration will become available in early 2026.
Residents must have a valid permit and an appointment to attend an event.
Select an event listed above to create an appointment. You will need your solid waste permit number. Only one sign-up per household per event.

Businesses and other non-residential source CESQGs
...
Oil-based paints & stains (latex and water-based paint accepted if more than 1/3 of a gallon per container). Visit PaintCare.org for more disposal options.
Personal care products
Products containing mercury
Unidentified products – The County’s hazardous waste contractor will test them to determine acceptability
...
Asbestos
Batteries (dispose of alkaline batteries in trash, undamaged rechargeable batteries can be brought to the electronics drop off area)
Controlled substances and medications (ie. barbiturates, or other prescription or non-prescription medication). For free safe disposal of pharmaceuticals, visit medtakebacknewyork.org
Empty containers

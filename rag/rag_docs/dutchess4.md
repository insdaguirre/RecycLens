...
state: NY
content_type: html
source_url: https://www.dutchessny.gov/Departments/Solid-Waste-Management/Household-Hazardous-Waste-Electronics-Event.htm
---
...
Home         Departments       Solid Waste Management    Household Hazardous Waste & Electronics Event 
...
Check back here in March for the 2026 list of events.
 
...
Lead based paints (NO latex or oil based!)
Photo chemicals
...
Resins
Solvents
Fluorescent tubes (tape together or put in box to prevent breakage)
Propane tanks
Computer monitors
CPU’s
Fax machines
...
Motor oil
Car batteries
Alkaline or rechargeable batteries. Drop off at auto centers or local repair shops.
Medications – Download the Dutchess County Prescription Medication Drop Box Program information page (.pdf)

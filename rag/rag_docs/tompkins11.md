...
state: NY
content_type: html
source_url: https://www.tompkinscountyny.gov/All-Departments/Recycling-Materials-Management/Other-Programs-and-Services/Borrow-A-Bin
---
...
How to Borrow-A-Bin
Fill out the Bin Request Form(PDF, 175KB). Bins will be available on a first come, first serve basis. Please allow time to process your request.
